...
static const Key keys[] = {
	...
	/*Media*/
	/**/
	{ 0, XF86XK_AudioMute,		spawn,		SHCMD("amixer -c 2 set 'Master' toggle") },
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer -c 2 set 'Master' 5%+") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer -c 2 set 'Master' 5%-") },
	...
	{ 0, XF86AudioStop,		spawn,		SHCMD("mpc repeat") },
